package scaleform.clik.ui
{
    ...
    public class InputDetails extends Object
    {
        ...
        public var fromJoystick:Boolean;

        public function InputDetails(param1:String, param2:Number, param3, param4:String = null, param5:uint = 0, param6:Boolean = false, param7:Boolean = false, param8:Boolean = false, param9:Boolean = false)
        {
            this.type = param1;
            this.code = param2;
            this.value = param3;
