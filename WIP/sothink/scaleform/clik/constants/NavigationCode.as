package scaleform.clik.constants
{
    ...
    public class NavigationCode extends Object
    {
        ...
        public static var GAMEPAD_DPAD_LR:String = "gamepad_dpad_lr";
        ...
        public static var GAMEPAD_RBLB:String = "gamepad_RBLB";
        public static var GAMEPAD_RTLT:String = "gamepad_RTLT";
        public static var GAMEPAD_RSTICK_SCROLL:String = "gamepad_R_Scroll";
        public static var GAMEPAD_RSTICK_TAB:String = "gamepad_R_Tab";
        public static var GAMEPAD_RSTICK_HOLD:String = "gamepad_R_Hold";
        public static var GAMEPAD_LSTICK_HOLD:String = "gamepad_L_Hold";
